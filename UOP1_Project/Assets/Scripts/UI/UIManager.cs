...
{
	[Header("Wwise Pause States")]
	[SerializeField] private AK.Wwise.Event Pause_On;
	[SerializeField] private AK.Wwise.Event Pause_Off;
	...
	private void Start()
	{
		Pause_Off.Post(gameObject);
	//	Debug.Log("Пренебречь");
	}
